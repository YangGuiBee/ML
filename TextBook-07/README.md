...
건강보험 청구 데이터를 활용한 머신러닝 기반 유방암 환자의 생존 여부 예측, 이덕규 외, 2023<br>
수영 경기결과 예측을 위한 머신러닝 기법 비교, 양민정, 2022<br>
로지스틱 회귀와 서포트벡터머신의 머신러닝 알고리즘 성능 비교 실험, 오윤태 외, 2019<br>
자연어처리와 기계학습을 이용한 요구사항 분석기술 비교 연구, 조병선 외, 2020<br>
기계학습 알고리즘을 이용한 기능적 요구사항과 비기능적 요구사항으로 요구사항 분류에 관한 연구, 조병선 외, 2018<br>
요구사항 시나리오 기계학습을 이용한 자동 소프트웨어 요구사항 패턴 추출기법, 고덕윤 외, 2016<br>
오렌지3 플랫폼을 활용한 AI 교수-학습 모델 개발 및 효과성 분석, 백우정, 2023<br>
미세먼지 예측을 위한 기계 학습 알고리즘의 적합성 평가, 조경우 외, 2019<br>
미세먼지 예측을 위한 기계학습 모델 간 성능 비교 연구 국내 발생 데이터를 중심으로, 성상하 외, 2020<br>
Do we need hundreds of classifiers to solve real world classification problems?, 2014<br>

---


# 건강보험 청구 데이터를 활용한 머신러닝 기반 유방암 환자의 생존 여부 예측, 이덕규 외, 2023
...
# 수영 경기결과 예측을 위한 머신러닝 기법 비교, 양민정, 2022
...
# 로지스틱 회귀와 서포트벡터머신의 머신러닝 알고리즘 성능 비교 실험, 오윤태 외, 2019
...
# 자연어처리와 기계학습을 이용한 요구사항 분석기술 비교 연구, 조병선 외, 2020
...
# 기계학습 알고리즘을 이용한 기능적 요구사항과 비기능적 요구사항으로 요구사항 분류에 관한 연구, 조병선 외, 2018
...
# 요구사항 시나리오 기계학습을 이용한 자동 소프트웨어 요구사항 패턴 추출기법, 고덕윤 외, 2016
...
# 오렌지3 플랫폼을 활용한 AI 교수-학습 모델 개발 및 효과성 분석, 백우정, 2023
...
# 미세먼지 예측을 위한 기계 학습 알고리즘의 적합성 평가, 조경우 외, 2019
...
# 미세먼지 예측을 위한 기계학습 모델 간 성능 비교 연구 국내 발생 데이터를 중심으로, 성상하 외, 2020
