...
---
	...
	[1] 선형 회귀 (Linear Regression)
  	...
  	[2] 일반화 선형 회귀(Generalized Linear Regression, GLM)
		...
		[2-7] 일반화 가법모형 (Generalized Additive Model, GAM)
		[2-8] 트위디 회귀 (Tweedie Regression)
		[2-9] 과산포 포아송 회귀 (Quasi-Poisson Regression)
		[2-10] 영과다 / 허들 회귀 (Zero-Inflated / Hurdle Regression)
