...
▣ 예제 : https://scikit-learn.org/stable/auto_examples/linear_model/plot_logistic_regression.html
...
### [2-2] 포아송 회귀 (Poisson Regression)
▣ 가이드 : https://scikit-learn.org/stable/modules/linear_model.html#poisson-regression
▣ API : https://scikit-learn.org/stable/modules/generated/sklearn.linear_model.PoissonRegressor.html
▣ 예제 : https://scikit-learn.org/stable/auto_examples/linear_model/plot_poisson_regression.html
...
▣ 가이드 : https://scikit-learn.org/stable/modules/linear_model.html#generalized-linear-models
▣ API : scikit‑learn 직접 API 없음(통상적으로 statsmodels의 GLM 사용)
...
▣ 가이드 : https://scikit-learn.org/stable/modules/linear_model.html#generalized-linear-models
▣ API : scikit‑learn 직접 API 없음(statsmodels NegativeBinomial 사용)
▣ 예제 : https://scikit-learn.org/stable/auto_examples/linear_model/index.html
...
▣ 가이드 : https://scikit-learn.org/stable/modules/linear_model.html#gamma-regression
▣ API : https://scikit-learn.org/stable/modules/generated/sklearn.linear_model.GammaRegressor.html
▣ 예제 : https://scikit-learn.org/stable/auto_examples/linear_model/plot_gamma_regression.html
...
▣ 가이드 : https://scikit-learn.org/stable/modules/linear_model.html#generalized-linear-models
▣ API : scikit‑learn 직접 API 없음(statsmodels InverseGaussian 사용)
▣ 예제 : https://scikit-learn.org/stable/auto_examples/linear_model/index.html
...
### [2-7] 트위디 회귀 (Tweedie Regression)
▣ 가이드 : https://scikit-learn.org/stable/modules/linear_model.html#tweedie-regression
▣ API : https://scikit-learn.org/stable/modules/generated/sklearn.linear_model.TweedieRegressor.html
▣ 예제 : https://scikit-learn.org/stable/auto_examples/linear_model/plot_tweedie_regression.html
...
▣ 가이드 : scikit‑learn 공식 가이드 없음
▣ API : scikit‑learn API 없음(lifelines 패키지 사용)
▣ 예제 : https://lifelines.readthedocs.io/en/latest/Survival%20Regression.html
...
▣ 가이드 : scikit‑learn 공식 가이드 없음
▣ API : scikit‑learn API 없음(statsmodels ZeroInflatedPoisson 등 사용)
▣ 예제 : https://www.statsmodels.org/stable/count_models.html
...
▣ 가이드 : scikit‑learn 공식 가이드 없음
▣ API : scikit‑learn API 없음(이항 회귀 + count 회귀를 결합한 2‑stage 사용자 구현)
▣ 예제 : https://www.statsmodels.org/stable/count_models.html
...
▣ 가이드 : scikit‑learn 공식 가이드 없음
▣ API : scikit‑learn API 없음(pyGAM 사용)
▣ 예제 : https://pygam.readthedocs.io/en/latest/notebooks/tour_of_pygam.html
...
▣ 가이드 : scikit‑learn 공식 가이드 없음
▣ API : scikit‑learn API 없음(PyMC 사용)
▣ 예제 : https://www.pymc.io/projects/docs/en/stable/learn/core_notebooks/glm.html
...
▣ 가이드 : https://scikit-learn.org/stable/modules/linear_model.html#ridge-regression
