...
|**[5-7] SCAD 벌점 회귀**|$\min_\beta \Vert y-X\beta\Vert_2^2 + \sum_{j=1}^p p_\lambda(|\beta_j|)$|큰 계수에서 벌점 소멸|oracle property 요구 연구|
|**[5-8] MCP 벌점 회귀**|$\min_\beta \Vert y-X\beta\Vert_2^2 + \sum_{j=1}^p p_\lambda(|\beta_j|)$|선형 감소 후 평탄화|대규모 고차원 회귀|
