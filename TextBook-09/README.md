...
**포아송 분포의 특징** : 평균( E[X]=λ )과 분산( Var(X)=λ )의 값이 같다.<br>
**포아송 분포의 성립 조건** : 종속변수가 빈도변수로 0이상 정수이거나, 왜도가 크거나, 분포유형이 포아송 로그선형일 경우<br> 
① 사건은 서로 독립적<br>
② 짧은 구간에서는 사건이 2번 이상 발생할 확률이 거의 0<br>
...
일정 주어진 시간 동안에 방문하는 고객의 수<br>
일정 주어진 생산시간 동안 발생하는 불량 수<br>
하룻동안 발생하는 출생자 수<br>
어떤 시간 동안 톨게이트를 통과하는 차량의 수<br>
어떤 페이지에 있는 오타의 발생률<br>
어떤 특정 면적의 삼림에서 자라는 소나무의 수<br>
