...
| 모델명 | scikit-learn Guide | scikit-learn API | scikit-learn Example |
|---|---|---|---|
| **[2-1] 이항 회귀** | https://scikit-learn.org/stable/modules/linear_model.html#logistic-regression | https://scikit-learn.org/stable/modules/generated/sklearn.linear_model.LogisticRegression.html | https://scikit-learn.org/stable/auto_examples/linear_model/plot_logistic_regression.html |
| **[2-2] 포아송 회귀** | https://scikit-learn.org/stable/modules/linear_model.html#poisson-regression | https://scikit-learn.org/stable/modules/generated/sklearn.linear_model.PoissonRegressor.html | https://scikit-learn.org/stable/auto_examples/linear_model/plot_poisson_regression.html |
| **[2-3] 준포아송 회귀** | https://scikit-learn.org/stable/modules/linear_model.html#generalized-linear-models | (직접 API 없음 – statsmodels 사용) | https://scikit-learn.org/stable/auto_examples/linear_model/index.html |
| **[2-4] 음이항 회귀** | https://scikit-learn.org/stable/modules/linear_model.html#generalized-linear-models | (직접 API 없음 – statsmodels 사용) | https://scikit-learn.org/stable/auto_examples/linear_model/index.html |
| **[2-5] 감마 회귀** | https://scikit-learn.org/stable/modules/linear_model.html#gamma-regression | https://scikit-learn.org/stable/modules/generated/sklearn.linear_model.GammaRegressor.html | https://scikit-learn.org/stable/auto_examples/linear_model/plot_gamma_regression.html |
| **[2-6] 역가우시안 회귀** | https://scikit-learn.org/stable/modules/linear_model.html#generalized-linear-models | (직접 API 없음 – statsmodels 사용) | https://scikit-learn.org/stable/auto_examples/linear_model/index.html |
| **[2-7] 트위디 회귀** | https://scikit-learn.org/stable/modules/linear_model.html#tweedie-regression | https://scikit-learn.org/stable/modules/generated/sklearn.linear_model.TweedieRegressor.html | https://scikit-learn.org/stable/auto_examples/linear_model/plot_tweedie_regression.html |
| **[2-8] 콕스 비례위험 모형** | (sklearn 공식 가이드 없음) | (sklearn API 없음 – lifelines 사용) | https://lifelines.readthedocs.io/en/latest/Survival%20Regression.html |
| **[2-9] 영과잉 모형** | (sklearn 공식 가이드 없음) | (sklearn API 없음 – statsmodels 사용) | https://www.statsmodels.org/stable/count_models.html |
| **[2-10] 허들 모형** | (sklearn 공식 가이드 없음) | (sklearn API 없음 – 2-stage 사용자 구현) | https://www.statsmodels.org/stable/count_models.html |
| **[2-11] 일반화 가법모형** | (sklearn 공식 가이드 없음) | (sklearn API 없음 – pygam 사용) | https://pygam.readthedocs.io/en/latest/notebooks/tour_of_pygam.html |
| **[2-12] 베이즈 GLM** | (sklearn 공식 가이드 없음) | (sklearn API 없음 – PyMC 사용) | https://www.pymc.io/projects/docs/en/stable/learn/core_notebooks/glm.html |
| **[2-13] 정규화 GLM** | https://scikit-learn.org/stable/modules/linear_model.html#ridge-regression | https://scikit-learn.org/stable/modules/linear_model.html#lasso | https://scikit-learn.org/stable/auto_examples/linear_model/index.html |
