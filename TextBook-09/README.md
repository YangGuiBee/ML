...
| **수식** | <img src="https://latex.codecogs.com/png.image?\dpi{120}\bg_white\log(\lambda_i)=\beta_0+\beta_1x_{1i}+\cdots+\beta_px_{pi}" alt="Poisson formula"/> <br> <img src="https://latex.codecogs.com/png.image?\dpi{120}\bg_white\lambda_i=e^{\eta_i}" alt="Poisson formula2"/> → 평균 사건수 | <img src="https://latex.codecogs.com/png.image?\dpi{120}\bg_white h(t%7CX)=h_0(t)\exp(\beta_1x_1+\beta_2x_2+\cdots+\beta_p x_p)" alt="Cox PH model" /> <br> <img src="https://latex.codecogs.com/png.image?\dpi{120}\bg_white h_0(t):\text{기저위험함수(baseline hazard)}" alt="Baseline hazard" /> |
