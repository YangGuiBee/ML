...
| [6-16] 베이즈 비선형 회귀 (*Bayesian Nonlinear Regression*) | ![eq](https://latex.codecogs.com/png.latex?p%28%5Ctheta%20%5Cmid%20D%29%20%5Cpropto%20p%28D%20%5Cmid%20%5Ctheta%29%5C%2C%20p%28%5Ctheta%29) | 불확실성 반영형 — 소표본 데이터, 확률적 예측 모델 |
| [6-17] 신경망 회귀 (*Neural Network Regression, MLP*) | ![eq](https://latex.codecogs.com/png.latex?%5Chat%7By%7D%20%3D%20f%28W_2%20%5C%2C%20%5Csigma%28W_1%20x%20%2B%20b_1%29%20%2B%20b_2%29) | Universal Approximation — 복잡한 비선형 함수 학습, 예측·제어 |
| [6-18] 특수 형상 회귀 (*Geometric Regression*) | ![eq](https://latex.codecogs.com/png.latex?%5Cmin_%7BR%2Ct%7D%20%5Csum_i%20%7C%7C%20x_i%20-%20%28R%20y_i%20%2B%20t%29%20%7C%7C%5E2) | 공간 변환 기반 — 3D 포인트 정합, 기하 보정, 영상 정렬, 구조광 측정 |
| [6-19] 로버스트 회귀 (*Robust Regression*) | ![eq](https://latex.codecogs.com/png.latex?%5Cmin_%7B%5Ctheta%7D%20%5Csum_i%20%5Crho%28y_i%20-%20f%28x_i%3B%5Ctheta%29%29) | 이상치·노이즈에 강건 — Huber, Tukey loss 사용, 실험데이터 보정 |
| [6-20] 혼합 회귀 (*Mixture of Regressions, MoR*) | ![eq](https://latex.codecogs.com/png.latex?p%28y%7Cx%29%20%3D%20%5Csum_k%20%5Cpi_k%20%5CN%28y%3Bf_k%28x%29%2C%5Csigma_k%5E2%29) | 여러 회귀모델의 혼합 — 군집별 이질적 패턴 모델링 |
| [6-21] 위치-규모-형상 회귀 (*GAMLSS*) | ![eq](https://latex.codecogs.com/png.latex?y%20%5Csim%20D%28%5Clambda_1%2C%5Clambda_2%2C%5Clambda_3%29%2C%5Clog%5Clambda_j%3D%5Ceta_j%28x%29) | 평균뿐 아니라 분산·왜도·첨도까지 설명 — 금융위험, 생존·보험분석 |
| [6-22] 함수형 회귀 (*Functional Regression*) | ![eq](https://latex.codecogs.com/png.latex?y%28t%29%3D%5Cint%20%5Cbeta%28s%2Ct%29x%28s%29ds%2B%5Cepsilon%28t%29) | 입력·출력이 함수형(곡선형) — 생체신호, 시계열, 스펙트럼 분석 |
| [6-23] 형상기반 회귀 (*Shape-aware / Geodesic Regression*) | ![eq](https://latex.codecogs.com/png.latex?%5Cmin_%7B%5Cmu%2Cv%7D%20%5Csum_i%20d_%7B%5CMathcal%7BM%7D%7D%5E2%28%5Cexp_%5Cmu%28v%20t_i%29%2C%20y_i%29) | 리만다양체 상 회귀 — 의료영상, 3D 형상·자세 추정 |
| [6-24] 딥 가우시안 프로세스 회귀 (*Deep Gaussian Process Regression*) | ![eq](https://latex.codecogs.com/png.latex?f_L%28x%29%3Df_L%28f_%7BL-1%7D%28...f_1%28x%29%29%29) | 계층적 GP — 불확실성+복잡한 비선형 구조 학습 |
| [6-25] 물리정보 회귀 (*Physics-Informed Regression, PINN*) | ![eq](https://latex.codecogs.com/png.latex?L%3D%5Calpha%5Csum_i%7C%7Cf%28x_i%3B%5Ctheta%29-y_i%7C%7C%5E2%2B%5Cbeta%5Csum_j%7C%7C%5Cmathcal%7BF%7D%28f%28x_j%3B%5Ctheta%29%29%7C%7C%5E2) | 물리제약 포함 회귀 — PDE/ODE 기반 공학·유체·재료 시뮬레이션 |
