...
| **[2-3] 콕스 비례위험 회귀 (Cox’s Proportional Hazard Regression)** | ![eq]([https://latex.codecogs.com/png.latex?h(t\mid](https://latex.codecogs.com/png.latex?h%28t\mid) X)=h_0(t)\exp(\beta_1x_1+\cdots+\beta_kx_k))                                                   | **그래프:** 생존확률 감소형 (Monotonic Decrease) <br> **적용:** 생존분석, 의료 생존율, 제품 수명/고장 예측      |
