...
# 연관규칙 알고리즘 수식 요약 (GitHub 이미지 렌더링 완성판)
...
| **[AR-3]** | **Eclat** (Equivalence Class Transformation) | TID 집합의 교집합으로 Support 계산 | ![](https://latex.codecogs.com/png.image?\dpi{140}Support(X)=\left|\bigcap_{i\in%20X}T(i)\right|) | ![](https://latex.codecogs.com/png.image?\dpi{140}\max_{X}\left|\bigcap_{i\in%20X}T(i)\right|\;\text{s.t.}\;\left|\bigcap_{i\in%20X}T(i)\right|\ge%20min\_sup) |
