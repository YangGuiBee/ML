...
| **[AR-3]** | **Eclat**<br>(Equivalence Class Transformation) | TID 집합의 교집합으로 Support 계산 | $Support(X)=\left|\bigcap\_{i\in X}T(i)\right|$<br>(여기서 $T(i)$는 항목 $i$가 포함된 트랜잭션 집합) | $\max\_X |\,\bigcap\_{i\in X}T(i)\,| \quad \text{s.t. } |\,\bigcap\_{i\in X}T(i)\,| \ge min\_sup$ |
