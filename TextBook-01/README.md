...
|구분|정의(종류)|
|---|---|
|인간적<br>사고|인간의 사고, 그리고 의사결정, 문제풀기, 학습 등의 활동에 연관(인지과학, 신경망)|
|합리적<br>사고|인지와 추론 행위를 가능하게 하는 계산의 연구(삼단논법 논리, 추론, 최적화)|
|인간적<br>행위|사람이 지능적으로 수행해야 하는 기능을 수행하는 기계의 제작을 위한 기술(자연어처리,지식표현,자동추론,컴퓨터시각,로봇공학,기계학습 등)|
|합리적<br>행위|지능적 에이전트와 설계에 관한 계산지능 연구(알파고, 행동로봇)|
