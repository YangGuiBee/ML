...
정의 : "기계가 인간처럼 생각하고 인식할 수 있는가? 인공지능은 컴퓨터가 사람처럼 대화하고 문제를 해결할 수 있는 능력을 의미한다."<br>
논문 : "Computing Machinery and Intelligence"<br>
설명 : 터링은 "컴퓨터 기계와 지능"이라는 논문에서 인공지능의 가능성을 논의하며, 기계가 인간처럼 생각할 수 있는지를 평가하기 위한 "터링 테스트"를 제안했습니다. 이는 AI의 철학적 기반을 다지는 중요한 작업이었습니다.<br>



### 1955년, 스튜어트 러셀과 피터 노빅 (Stuart Russell and Peter Norvig)
정의 : "인공지능은 인간의 지능적 행동을 모방하여 인간과 유사하게 학습하고, 추론하며, 적응할 수 있는 시스템을 만드는 것에 관한 연구이다."<br>
...
정의 : "인공지능은 지능적인 행동을 수행하는 기계를 설계하고, 이들이 사람처럼 사고하고 배우는 시스템을 만드는 과학과 공학이다."<br>
...
정의 : "인공지능은 컴퓨터 프로그램이 어떤 목표를 달성하기 위해 필요한 논리적, 수학적 과정을 자동으로 수행할 수 있게 하는 능력이다."<br>
...
정의 : "인공지능은 인간처럼 사고할 수 있는 기계를 만드는 과학이다."<br>
회의 : 다트머스 회의에서 발표<br>
...
정의 : "인공지능은 인간의 지적 능력을 확장하거나 이를 초월하는 능력을 가진 기계나 프로그램을 만드는 것이다."<br>
