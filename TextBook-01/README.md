...
### <span style='background-color: #fff5b1'> 4. 전문가 시스템의 부상과 상업화 (1980년대)</span><br>											
...
### <span style='background-color: #fff5b1'> 5. 두 번째 AI 겨울 (1990년대)</span><br>											
...
### <span style='background-color: #fff5b1'> 6. 머신러닝과 딥러닝의 부상 (2000년대~현재)</span><br>											
...
정의 : "기계가 인간처럼 생각하고 인식할 수 있는가? 인공지능은 컴퓨터가 사람처럼 대화하고 문제를 해결할 수 있는 능력을 의미한다."
논문 : "Computing Machinery and Intelligence"
설명 : 터링은 "컴퓨터 기계와 지능"이라는 논문에서 인공지능의 가능성을 논의하며, 기계가 인간처럼 생각할 수 있는지를 평가하기 위한 "터링 테스트"를 제안했습니다. 이는 AI의 철학적 기반을 다지는 중요한 작업이었습니다.



### 1955년, 스튜어트 러셀과 피터 노빅 (Stuart Russell and Peter Norvig)
정의 : "인공지능은 인간의 지능적 행동을 모방하여 인간과 유사하게 학습하고, 추론하며, 적응할 수 있는 시스템을 만드는 것에 관한 연구이다."
...
정의 : "인공지능은 지능적인 행동을 수행하는 기계를 설계하고, 이들이 사람처럼 사고하고 배우는 시스템을 만드는 과학과 공학이다."
회의 : 다트머스 회의에서  "인공지능"이라는 용어를 처음 제안
설명 : 이 회의는 AI의 출발점으로 여겨지며, 매카시는 AI를 광범위하게 정의하면서 인간처럼 사고하고 배우는 기계를 만드는 것이 목표.



### 1956년, 앨런 뉴웰과 허버트 사이먼 (Allen Newell and Herbert A. Simon)
정의 : "인공지능은 컴퓨터 프로그램이 어떤 목표를 달성하기 위해 필요한 논리적, 수학적 과정을 자동으로 수행할 수 있게 하는 능력이다."
...
정의 : "인공지능은 인간처럼 사고할 수 있는 기계를 만드는 과학이다."
회의 : 다트머스 회의에서 발표
설명 : 민스키는 AI 연구의 선구자로, 인간 지능을 모방하는 기계를 만드는 과학으로 AI를 정의했으며 MIT에서 AI 연구실을 설립하며, AI의 발전에 중요한 역할.
...
### 1999년, 레이 커즈와일 (Ray Kurzweil)
정의 : "인공지능은 인간의 지적 능력을 확장하거나 이를 초월하는 능력을 가진 기계나 프로그램을 만드는 것이다."
...
정의 : "인공지능은 확률적 추론을 통해 불확실한 상황에서 결정을 내리고, 지능적인 행동을 구현하는 시스템을 연구하는 학문이다."
...
일부 코드는 파이썬 2.7과 호환될 수 있지만 파이썬 2.7의 공식 지원이 2019년 말에 끝났기 때문에 상당수의 오픈 소스 라이브러리는 이미 파이썬 2.7에 대한 지원을 중단했습니다(https://python3statement.org/). 
