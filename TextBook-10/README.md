...
# [1-1] k-Means
▣ 정의 : 데이터를 K개의 군집으로 나누고 각 군집의 중심점(centroid)을 군집 내 데이터 포인트들의 평균으로 정의하여 각 데이터의 포인트와 군집 중심간의 거리를 반복적으로 계산하여 할당하는 군집화 알고리즘<br>
...
# [1-2] K-medoids
▣ 정의: K-means와 유사하지만, 각 군집의 중심을 실제 데이터 포인트(medoid)로 설정함으로써 이상치(outlier)에 더 강하다.<br>
...
# [5-2] COBWEB
▣ 정의: 개념 형성을 기반으로 하는 계층적 군집화 알고리즘으로, 각각의 노드가 개념을 나타내는 분류 트리를 생성하여 새로운 데이터를 점진적으로 학습<br>
